...
import DraggableCardsContainer from "../main/DraggableCardsContainer";
...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 md:grid-cols-6 lg:grid-cols-4 md:grid-row-7 gap-4 lg:gap-8 mx-auto",
        className
      )}
    >
      {children}
...
export const BentoGridItem = ({
  ...
  const rightLists = ["Express", "Tailwind", "Python", "Java"];
  ...
  const handleCopy = () => {
    const text = "abidi.benhassen.a@gmail.com";
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {id === 3 && (
            ...
            <DraggableCardsContainer leftLists={leftLists} rightLists={rightLists} />
